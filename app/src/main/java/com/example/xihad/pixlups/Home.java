...
public class Home extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,Bundle savedInstanceState) {
        ...
        recyclerView7 = view.findViewById(R.id.reclyleId7);
        recyclerView8 = view.findViewById(R.id.reclyleId8);
        recyclerView9 = view.findViewById(R.id.reclyleId9);
        recyclerView10 = view.findViewById(R.id.reclyleId10);
        recyclerView11 = view.findViewById(R.id.reclyleId11);
        recyclerView12 = view.findViewById(R.id.reclyleId12);
        ...
        mref8.keepSynced(true);
        mref9.keepSynced(true);
        mref10.keepSynced(true);
        ...
        button7 = view.findViewById(R.id.Street_photographyId);
        button8 = view.findViewById(R.id.Children_photosId);
        button9 = view.findViewById(R.id.PortraitId);
        button10 = view.findViewById(R.id.Black_and_whiteId);
        button11 = view.findViewById(R.id.Fashion_and_glamourId);
        button12 = view.findViewById(R.id.OthersId);
        ...
        black = view.findViewById(R.id.blk);
        fashion = view.findViewById(R.id.fsh);
        others = view.findViewById(R.id.oher);
    ...
    public void onClick(View v) {
        ...
        if (v.getId()==R.id.Street_photographyId){
            Intent intent  = new Intent(getActivity(),ShowItem.class);
            intent.putExtra("name", "Street_photography");
            startActivity(intent);
        }
        if (v.getId()==R.id.Children_photosId){
            Intent intent  = new Intent(getActivity(),ShowItem.class);
            intent.putExtra("name", "Children_photos");
            startActivity(intent);
        }
        if (v.getId()==R.id.PortraitId){
            Intent intent  = new Intent(getActivity(),ShowItem.class);
            intent.putExtra("name", "Portrait");
            startActivity(intent);
        }
        if (v.getId()==R.id.Black_and_whiteId){
            Intent intent  = new Intent(getActivity(),ShowItem.class);
            intent.putExtra("name", "Black_and_white");
            startActivity(intent);
        }
        if (v.getId()==R.id.Fashion_and_glamourId){
            Intent intent  = new Intent(getActivity(),ShowItem.class);
